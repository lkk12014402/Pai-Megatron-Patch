...
def model_provider(pre_process=True, post_process=True) -> Union[GPTModel, megatron.legacy.model.GPTModel]:
    ...
    if args.use_legacy_models:
        ...
        # for qwen2.5 7B 14B 32B ...
        # https://github.com/alibaba/Pai-Megatron-Patch/blob/main/examples/qwen2_5/run_mcore_qwen.sh#L164
        # qwen2.5
        # args.padded_vocab_size = 151643 + 421
        # qwen3
        args.padded_vocab_size = 151643 + 293
...
def loss_func(loss_mask: torch.Tensor, output_tensor: torch.Tensor):
    ...
    # print_rank_0(f"loss: , {losses.tolist()}")

    loss_mask = loss_mask.view(-1).float()
    # print_rank_0(f"loss_mask: , {loss_mask}")
    # print_rank_0(f"loss_mask: , {loss_mask.tolist()}")
...
def loss_func(loss_mask: torch.Tensor, output_tensor: torch.Tensor):
    ...
    losses = output_tensor.float()
    loss_mask = loss_mask.view(-1).float()
    #print_rank_0(f"losses: , {losses}")
    #print_rank_0(f"losses: , {losses.tolist()}")
...
def forward_step(data_iterator, model: GPTModel):
    ...
    # print_rank_0(f"tokens: {tokens.tolist()}")
    # print(tokens.tolist())
    # print_rank_0(f"labels: {labels}")
    # print_rank_0(labels.tolist())
    #print_rank_0(f"loss_mask: {loss_mask}")
    ...
    # print_rank_0(f"output_tensor: {output_tensor}")
